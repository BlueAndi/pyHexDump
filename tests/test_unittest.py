...
def test_tmpl_element():
    ...
    # Test uint8
    test_value = 1
    tmpl_element = TmplElement("test", 0, test_value, 8)
    assert f"0x{test_value:02X}" == tmpl_element.hex()
    assert test_value == tmpl_element

    # Test uint16
    test_value = 45000
    tmpl_element = TmplElement("test", 0, test_value, 16)
    assert f"0x{test_value:04X}" == tmpl_element.hex()
    assert test_value == tmpl_element

    # Test uint32
    test_value = 80000
    tmpl_element = TmplElement("test", 0, test_value, 32)
    assert f"0x{test_value:08X}" == tmpl_element.hex()
    assert test_value == tmpl_element

    # Test uint64
    test_value = 12345789
    tmpl_element = TmplElement("test", 0, test_value, 64)
...
def test_tmpl_element_with_array_part_1():
    ...
    # Test array of uint8
    test_values = [0, 1, 2, 3]
    tmpl_element = TmplElement("test", 0, test_values, 8)
    ...
    # Test uint16
    test_values = [0, 1, 2, 3]
    tmpl_element = TmplElement("test", 0, test_values, 16)
    ...
    # Test uint32
    test_values = [0, 1, 2, 3]
    tmpl_element = TmplElement("test", 0, test_values, 32)
    ...
    # Test uint64
    test_values = [0, 1, 2, 3]
    tmpl_element = TmplElement("test", 0, test_values, 64)
